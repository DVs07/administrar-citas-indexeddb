...
class UI {
    ...
    imprimirCitas() { 
        ...
        // Indicar si hay citas en la DB
        const total = objectStore.count();
        total.onsuccess = function() {
            //console.log(total.result); // Muestra la cantidad de registros de la DB
            //this.textoHeading();

            fnTextoHeading(total.result);
            console.log('Cantidad de registros en la IndexedDB: [' + total.result + ']');
        }
...
function crearDB(){
    ...
    crearDB.onsuccess = function(){
        ...
        //console.log(DB);
         ...
         // Mostrar las citas al cargar (IndexedDB ya esta listo)
        ui.imprimirCitas();
